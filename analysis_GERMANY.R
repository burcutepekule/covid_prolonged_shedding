...
# country_name    = "GERMANY"; # end_index_in    = 9;
# country_name    = "China"; # end_index_in    = 14;
# country_name    = "Greece"; # end_index_in    = 7;
country_name    = "Germany"; # end_index_in    = 4;
...
if((country_name=="Germany")==TRUE){
  print("Calculating for Germany")
  popsize_data_all = 83748232;
  data_control = ymd("2020-03-23")
  date_control = ymd("2020-03-23")
  date_relax   = ymd("2020-04-20")
}
...
write.table(agg_data_use, file = paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_GERMANY/agg_data_use_",end_index_in,".csv"))
write.table(agg_data_all, file = paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_GERMANY/agg_data_all_",end_index_in,".csv"))
...
# save(T_modelBT, file =paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_GERMANY/RDATA/T_modelBT_rc_",r_c_in,"_mrelax_",m_relax_in,"_endidx_",end_index_in,".RData"))
...
write.table(model_output_fitted, file = paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_GERMANY/CSVS/output_fit_rc_",r_c_in,"_mrelax_",m_relax_in,"_endidx_",end_index_in,".csv"))
...
ggsave(paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_GERMANY/FIGS/figure_fit_rc_",r_c_in,"_mrelax_",m_relax_in,".png"),width = 20, height = 10)
...
write.table(parameterSummary$summary, file = paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_GERMANY/CSVS/parameters_fit_rc_",r_c_in,"_mrelax_",m_relax_in,"_endidx_",end_index_in,".csv"))
...
model_output_all = summary(T_modelBT,pp3)[[1]] %>%
  ...
  mutate(populations=factor(type,levels=pp3,
                            labels=c("Number of daily cases","Number of daily deaths")))
write.table(model_output_all, file = paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_GERMANY/CSVS/output_all_rc_",r_c_in,"_mrelax_",m_relax_in,"_endidx_",end_index_in,".csv"))
...
ggplot() +
  ...
  labs(x="Days",y="N")+
  scale_y_continuous(trans = 'log10')
ggsave(paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_GERMANY/FIGS/figure_all_rc_",r_c_in,"_mrelax_",m_relax_in,"_endidx_",end_index_in,".png"),width = 20, height = 10)
