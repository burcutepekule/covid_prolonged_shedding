...
write.table(agg_data_use, file = paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_ITALY/agg_data_use_",end_index_in,".csv"))
write.table(agg_data_all, file = paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_ITALY/agg_data_all_",end_index_in,".csv"))
...
# save(T_modelBT, file =paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_ITALY/RDATA/T_modelBT_rc_",r_c_in,"_mrelax_",m_relax_in,"_endidx_",end_index_in,".RData"))
...
write.table(model_output_fitted, file = paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_ITALY/CSVS/output_fit_rc_",r_c_in,"_mrelax_",m_relax_in,"_endidx_",end_index_in,".csv"))
...
ggsave(paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_ITALY/FIGS/figure_fit_rc_",r_c_in,"_mrelax_",m_relax_in,".png"),width = 20, height = 10)
...
write.table(parameterSummary$summary, file = paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_ITALY/CSVS/parameters_fit_rc_",r_c_in,"_mrelax_",m_relax_in,"_endidx_",end_index_in,".csv"))
...
model_output_all = summary(T_modelBT,pp3)[[1]] %>%
  ...
  mutate(populations=factor(type,levels=pp3,
                            labels=c("Number of daily cases","Number of daily deaths")))
write.table(model_output_all, file = paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_ITALY/CSVS/output_all_rc_",r_c_in,"_mrelax_",m_relax_in,"_endidx_",end_index_in,".csv"))
...
ggplot() +
  ...
  labs(x="Days",y="N")+
  scale_y_continuous(trans = 'log10')
ggsave(paste0("/net/cephfs/data/btepek/COVID_IC/IC_OUT/OUT_ITALY/FIGS/figure_all_rc_",r_c_in,"_mrelax_",m_relax_in,"_endidx_",end_index_in,".png"),width = 20, height = 10)
